...
(function( $ ) {
	...
	$.fn.simplePlayer = function() {
		...
		function onPlayerReady(event) {
			var replay = document.getElementsByClassName('play');
		...
		play.bind('click', function () {
			...
			if ( !$('.player' ).length ) {
				...
				$(this).css('background-image', 'url(http://d2xcq4qphg1ge9.cloudfront.net/assets/9704/3250168/original_play-button.png), url(' + video.children().attr('src') + ')').hide();
